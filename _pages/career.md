...
## 사내 카카오 마케팅팀 광고 단가 모니터링 서비스 개발(2차 리마스터)
...
### - 프로젝트 요약
 ...
 - 여기까지만 해도 전의 EC2 를 Crawling Server 로 만들어서 사용하던 시절이 구석기 시대에 살았었구나를 느끼게 함.
...
## 사내 카카오 마케팅팀 광고 단가 모니터링 서비스 개발(1차 리마스터)
...
- 인포맥v2 기획 및 API 서버 개발, 비용 및 성능 개선(개발 중), django, django rest framework
---
